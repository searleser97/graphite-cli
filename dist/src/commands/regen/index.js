...
class RegenCommand extends abstract_command_1.default {
    _execute(argv) {
        return __awaiter(this, void 0, void 0, function* () {
            const branch = yield branch_1.default.getCurrentBranch();
...
function recursiveRegen(branch, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (metaParent &&
            ...
            yield recursiveRegen(metaParent, opts);
        }
            ...
            yield recursiveRegen(gitParents[0], opts);
        }
            ...
            log_1.log(chalk_1.default.yellow(`Error: No regen patern detected for git: ${gitParents}, meta: ${metaParent}, exiting`), opts);
            process.exit(1);
        }
    });
}
