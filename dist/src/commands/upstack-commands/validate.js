...
exports.description = "Validate that Graphite's stack metadata for all upstack branches matches the branch relationships stored in git.";
exports.builder = args;
exports.canonical = "upstack validate";
