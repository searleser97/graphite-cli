    ...
    _execute(argv) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dagsAreEqual = Object.keys(gitInfo.dag).length == Object.keys(metaInfo.dag).length &&
                Object.keys(gitInfo.dag).every((key) => metaInfo.dag[key] != undefined &&
            ...
            if (dagsAreEqual) {
                ...
                console.log([
                    ...
                    `Run "${chalk_1.default.green("gp stack fix")}" to update the git stack to match the meta stack.`,
                    `Alternatively, run "${chalk_1.default.green("gp stack regen")}" to update the meta-stack to match the git-stack.\n`,
                ].join("\n"));
