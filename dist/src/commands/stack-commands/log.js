...
exports.LogStackCommand = void 0;
const child_process_1 = require("child_process");
const yargs_1 = __importDefault(require("yargs"));
const abstract_command_1 = __importDefault(require("../../lib/abstract_command"));
const args = {};
exports.default = yargs_1.default.command("log", "Log stack", args, (argv) => __awaiter(void 0, void 0, void 0, function* () {
    yield new LogStackCommand().execute(argv);
}));
class LogStackCommand extends abstract_command_1.default {
    _execute(argv) {
...
exports.LogStackCommand = LogStackCommand;
LogStackCommand.args = args;
