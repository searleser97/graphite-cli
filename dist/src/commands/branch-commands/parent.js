    ...
    return telemetry_1.profile(argv, () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (argv.set) {
            ...
            if (parent) {
                ...
                utils_1.logInfo(`Current branch (${branch}) has no parent branch set in Graphite. Consider running \`gp branch parent --set <parent>\`, \`gp stack fix\`, or \`gp upstack onto <parent>\` to set a parent branch in Graphite.`);
            }
        }
    }));
});
