...
function printStacksBehindTrunk() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const minStackCommittedToShow = currentUnixTimestamp -
            config_1.repoConfig.getLogMaxDaysShownBehindTrunk() * secondsInDay;
        const maxStacksToShow = config_1.repoConfig.getLogMaxStacksShownBehindTrunk();
