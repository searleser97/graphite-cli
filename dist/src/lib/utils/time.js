...
exports.getReadableTimeBeforeNow = void 0;
...
function getReadableTimeBeforeNow(earlierTimeInSeconds) {
    const nowInSeconds = Date.now() / MILLISECONDS_IN_SECONDS;
    return `${getReadableTimeDiff(earlierTimeInSeconds, nowInSeconds)} ago`;
}
exports.getReadableTimeBeforeNow = getReadableTimeBeforeNow;
function getReadableTimeDiff(earlierTimeInSeconds, laterTimeInSeconds) {
