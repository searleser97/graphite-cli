...
import { logError, logInfo, logNewline, logSuccess, logTip, logWarn } from "./splog";
...
export { gpExecSync, logError, logInfo, logSuccess, logWarn, logNewline, checkoutBranch, rebaseInProgress, detectStagedChanges, uncommittedChanges, unstagedChanges, getTrunk, GitRepo, parseArgs, makeId, getCommitterDate, preprocessCommand, signpostDeprecatedCommands, logTip, getRepoRootPath, VALIDATION_HELPER_MESSAGE, };
