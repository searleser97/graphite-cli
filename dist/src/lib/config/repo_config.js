...
class RepoConfig {
    ...
    getRepoOwner() {
        ...
        throw new errors_1.ExitFailedError("Could not determine the owner of this repo (e.g. 'screenplaydev' in the repo 'screenplaydev/graphite-cli'). Please run `gp repo-config owner --set <owner>` to manually set the repo owner.");
    }
    path() {
    ...
    getRepoName() {
        ...
        throw new errors_1.ExitFailedError("Could not determine the name of this repo (e.g. 'graphite-cli' in the repo 'screenplaydev/graphite-cli'). Please run `gp repo-config name --set <owner>` to manually set the repo name.");
    }
    setRepoName(name) {
        this._data.name = name;
        this.save();
    }
    getLogMaxDaysShownBehindTrunk() {
        var _a, _b;
        return (_b = (_a = this._data.logSettings) === null || _a === void 0 ? void 0 : _a.maxDaysShownBehindTrunk) !== null && _b !== void 0 ? _b : 30;
    }
    setLogMaxDaysShownBehindTrunk(n) {
        this._data.logSettings = Object.assign(Object.assign({}, this._data.logSettings), { maxDaysShownBehindTrunk: n });
        this.save();
    }
    getLogMaxStacksShownBehindTrunk() {
        var _a, _b;
        return (_b = (_a = this._data.logSettings) === null || _a === void 0 ? void 0 : _a.maxStacksShownBehindTrunk) !== null && _b !== void 0 ? _b : 10;
    }
    setLogMaxStacksShownBehindTrunk(n) {
        this._data.logSettings = Object.assign(Object.assign({}, this._data.logSettings), { maxStacksShownBehindTrunk: n });
        this.save();
    }
}
