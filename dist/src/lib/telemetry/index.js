...
exports.profile = exports.logCommand = exports.userEmail = exports.shouldReportTelemetry = exports.checkForUpgrade = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (response.status == 200) {
                const prompt = JSON.parse(response.body.toString()).prompt;
                if (prompt) {
                    if (!prompt.blocking) {
                        console.log(chalk_1.default.yellow(prompt.message));
                    }
                    else {
                        console.log(chalk_1.default.red(prompt.message));
                        process.exit(1);
                    }
                }
            }
