...
exports.profile = exports.userEmail = exports.shouldReportTelemetry = exports.checkForUpgrade = void 0;
...
function checkForUpgrade() {
    return __awaiter(this, void 0, void 0, function* () {
        return tracer_1.default.span({ name: "function", resource: "checkForUpgrade" }, () => __awaiter(this, void 0, void 0, function* () {
...
function logCommand(commandName, durationMiliSeconds, err) {
    return __awaiter(this, void 0, void 0, function* () {
        if (shouldReportTelemetry()) {
            try {
                yield Promise.all([
                    retyped_routes_1.request.requestWithArgs(api_1.API_SERVER, graphite_cli_routes_1.default.logCommand, {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield tracer_1.default.span({
                ...
                meta: Object.assign(Object.assign({ user: userEmail() || "NotFound", version: package_json_1.version, args: parsedArgs.args, alias: parsedArgs.alias }, (numCommits ? { commits: numCommits.toString() } : {})), (numBranches ? { branches: numBranches.toString() } : {})),
            ...
            const end = Date.now();
            yield Promise.all([logCommand(parsedArgs.command, end - start, err)]);
            // eslint-disable-next-line no-restricted-syntax
            process.exit(1);
        }
        const end = Date.now();
