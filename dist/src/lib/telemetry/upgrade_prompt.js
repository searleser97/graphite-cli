...
function printAndClearOldMessage() {
    const oldMessage = config_1.userConfig.getMessage();
    ...
    if (oldMessage && package_json_1.version == oldMessage.cliVersion) {
        console.log(chalk_1.default.yellow(oldMessage.contents) + "\n\n");
        config_1.userConfig.setMessage(undefined);
    }
}
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (response._response.status == 200) {
                if (response.prompt) {
                    config_1.userConfig.setMessage({
