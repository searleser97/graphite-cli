...
class Branch {
    ...
    getParentFromMeta() {
        ...
        if (this.name === utils_1.getTrunk().name ||
            this.pointsToSameCommitAs(utils_1.getTrunk())) {
            return undefined;
        }
        ...
        if (parentName) {
            if (parentName === this.name) {
                ...
                utils_1.logErrorAndExit(`Branch (${this.name}) has itself listed as a parent in the meta. Deleting (${this.name}) parent metadata and exiting.`);
            }
