...
class Branch {
    ...
    static allBranchesWithPredicate(predicate, opts) {
        let branches = Branch.allBranches({
            sort: (opts === null || opts === void 0 ? void 0 : opts.minCommittedUnixTimestamp) !== undefined
                ? "-committerdate"
                : opts === null || opts === void 0 ? void 0 : opts.sort,
        });
        if (opts === null || opts === void 0 ? void 0 : opts.useMemoizedResults) {
            branches = branches.map((branch) => branch.useMemoizedResults());
        }
        const minCommittedUnixTimestamp = opts === null || opts === void 0 ? void 0 : opts.minCommittedUnixTimestamp;
        ...
        for (let i = 0; i < branches.length; i++) {
            ...
            if (minCommittedUnixTimestamp !== undefined &&
    ...
    static getAllBranchesWithParents(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.allBranchesWithPredicate((branch) => branch.getParentsFromGit().length > 0, opts);
        });
    }
    head() {
    ...
    getChildrenOrParents(opt) {
        ...
        return telemetry_1.tracer.spanSync({
            ...
            const headSha = child_process_1.execSync(`git rev-parse ${this.name}`)
                .toString()
                .trim();
            return Array.from(traverseGitTreeFromCommitUntilBranch(headSha, gitTree, getBranchList({ useMemoizedResult: useMemoizedResults }), 0)).map((name) => {
