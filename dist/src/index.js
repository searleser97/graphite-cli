...
yargs_1.default
    ...
    .command("prev", "If you're in a stack: Branch A → Branch B (you are here) → Branch C. Takes you to the previous branch (Branch A). If there are two parent branches, errors out and tells you the various branches you could go to.", next_or_prev_1.PrevCommand.args, (argv) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    .command("submit", "Experimental: Create PR's for each branch in the current stack", submit_1.default.args, (argv) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    .command("validate", "Validates that the gp meta graph matches the current graph of git branches and commits.", validate_1.default.args, (argv) => __awaiter(void 0, void 0, void 0, function* () {
    yield new validate_1.default().execute(argv);
}))
    .command("feedback <message>", "Post a string directly to the maintainers' Slack where they can factor in your feedback, laugh at your jokes, cry at your insults, or test the bounds of Slack injection attacks.", feedback_1.default.args, (argv) => __awaiter(void 0, void 0, void 0, function* () {
    yield new feedback_1.default().execute(argv);
}))
    .command("sync", "Delete any stacks that have been merged or squashed into your trunk branch, and restack their children recursively.", sync_1.default.args, (argv) => __awaiter(void 0, void 0, void 0, function* () {
    yield new sync_1.default().execute(argv);
}))
