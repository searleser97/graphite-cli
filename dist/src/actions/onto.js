...
function ontoAction(onto) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield stackOnto(originalBranch, onto);
        utils_1.checkoutBranch(originalBranch.name);
    });
}
exports.ontoAction = ontoAction;
function stackOnto(currentBranch, onto) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        utils_1.gpExecSync({
            ...
            if (utils_1.rebaseInProgress()) {
                throw new errors_1.RebaseConflictError("Please resolve the rebase conflict and then continue with your `upstack onto` command.");
            }
            else {
        ...
        yield fix_1.restackBranch(currentBranch);
