    ...
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield prompts_1.default({
            ...
            choices: ["rebase", "regen"].map((r) => {
                return {
                    title: r === "rebase"
                        ? `Graphite stacks (${chalk_1.default.green("common choice")})\n` +
                            opts.metaStack
                                .toString()
                                .split("\n")
                                .map((l) => "    " + l)
...
function regenAllStacks() {
    const allGitStacks = new wrapper_classes_1.GitStackBuilder().allStacksFromTrunk();
...
function recursiveRegen(node) {
    ...
    if (branch.name !== trunk_1.getTrunk().name) {
        ...
        const newParent = ((_a = node.parents[0]) === null || _a === void 0 ? void 0 : _a.branch) || trunk_1.getTrunk(); // TODO: Deal with regen if there are multi parents
