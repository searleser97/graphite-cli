...
function commitAmendAction(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (git_utils_1.workingTreeClean()) {
            yield fix_1.fixAction(opts.silent);
        }
        else {
            utils_1.logWarn("Cannot fix upstack automatically, some uncommitted changes remain. Please commit or stash, and then `gp stack fix`");
        }
    });
}
