...
exports.saveBranchPRInfo = exports.inferPRBody = exports.inferPRTitle = exports.submitBranches = exports.submitAction = void 0;
...
function getSingleCommitOnBranch(branch) {
    ...
    return new commit_1.default(commits[0]);
}
...
function printSubmittedPRInfo(prs) {
    ...
    prs.forEach((pr) => {
        ...
        utils_1.logNewline();
        utils_1.logInfo(`See your full stack on https://app.graphite.dev`);
    });
}
