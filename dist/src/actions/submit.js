...
function submitAction(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const stack = args.scope === "DOWNSTACK"
            ? new wrapper_classes_1.MetaStackBuilder().downstackFromBranch(currentBranch)
            : new wrapper_classes_1.MetaStackBuilder().fullStackFromBranch(currentBranch);
